...
export const PALETTES: Palette[] = [
  {
    ...
    dim: '#5C5C66', mid: '#8D8D98', hi: '#EAEAEC', acc: '#D97B3C',
  ...
  },
  {
    ...
    dim: '#6B5F58', mid: '#9A8B81', hi: '#EEE9E4', acc: '#C4553F',
  ...
  },
  {
    ...
    dim: '#5A5A64', mid: '#8A8A95', hi: '#E9E9EC', acc: '#4C6FE3',
    accfg: '#F2F4FF', pgsh: DARK_SHADOW,
  },
  {
    id: 'sulphur', label: 'Sulphur', note: 'brass on olive black', dark: true,
    bg: '#0A0A09', rail: '#0D0D0B', panel: '#131310', line: '#26251E',
    dim: '#605F52', mid: '#8F8E7F', hi: '#EBEAE3', acc: '#C9A227',
  ...
  },
  {
    ...
    dim: '#57635B', mid: '#85928A', hi: '#E6EAE7', acc: '#6E8F4E',
  ...
  },
  {
    ...
    dim: '#635663', mid: '#948994', hi: '#EBE7EA', acc: '#A8496A',
    accfg: '#FCF2F5', pgsh: DARK_SHADOW,
  },
  {
    id: 'noir', label: 'Noir', note: 'white on pure black', dark: true,
    bg: '#000000', rail: '#040404', panel: '#0B0B0B', line: '#1E1E1E',
    dim: '#585858', mid: '#909090', hi: '#FFFFFF', acc: '#F2F2F2',
    accfg: '#000000',
  ...
  },
  {
    ...
    dim: '#837D73', mid: '#565149', hi: '#191713', acc: '#B05C24',
    accfg: '#FFF8F2',
  ...
  },
  {
    ...
    dim: '#827E73', mid: '#55524A', hi: '#181713', acc: '#4F6B36',
    accfg: '#F4F7EF',
  ...
  },
  {
    ...
    dim: '#7A8079', mid: '#4D534C', hi: '#111412', acc: '#4F6B36',
    accfg: '#F4F7EF',
  ...
  },
  {
    ...
    dim: '#8A8375', mid: '#5A5449', hi: '#161410', acc: '#2F4B8C',
    accfg: '#F4F6FF',
  ...
  },
  {
    ...
    dim: '#7B8085', mid: '#4E5357', hi: '#121416', acc: '#8C3A2E',
    accfg: '#FFF4F1',
